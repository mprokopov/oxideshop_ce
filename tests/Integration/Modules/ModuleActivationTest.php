...
final class ModuleActivationTest extends BaseModuleTestCase
{
     ...
     * @dataProvider providerModuleActivation
     */
    public function testModuleActivationInMainShopDidNotActivatedInSubShop(
        array $aInstallModules,
        string $sModule,
        array $aResultToAsserts
    ): void {
    ...
    protected function caseReactivatedWithRemovedExtension(): array
    {
        return [
