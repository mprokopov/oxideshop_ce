...
final class ModuleRemoveTest extends BaseModuleTestCase
{
    ...
    {
        return [
            $this->caseRemoveOneExtensionWithEverything(),
            $this->caseRemoveAllExtensionWithEverything(),
    ...
    private function caseRemoveOneExtensionWithEverything(): array
    {
        return [
    ...
    private function caseRemoveAllExtensionWithEverything(): array
    {
        return [
